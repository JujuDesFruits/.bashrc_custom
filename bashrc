...
alias git-details='~/.GitEye-2.2.0-linux.x86_64/GitEye &'
alias 2048='./bash2048/bash2048.sh'
...
alias test_start="sh ~/.create_machine_test.sh"
alias test_stop="sh ~/.delete_machine_test.sh"
